...
- [0.14.0：终端与 Git 修复、界面及快捷键整理](releases/0.14.0.md)
- [0.11.0：配置与扩展、后台命令及定时任务](releases/0.11.0.md)
- [0.10.0：Git 操作与原生代码审查](releases/0.10.0.md)
- [0.9.0：原生历史与隔离工作目录](releases/0.9.0.md)
